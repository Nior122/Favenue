      ...
      <DialogContent className="max-w-md bg-gray-900 border border-gray-700">
        ...
        <div className="space-y-6 p-4">
          ...
          <div className="text-xs text-gray-500 text-center">
            You'll be redirected to verification. You must stay on the page for 5 seconds to unlock content. If not, image won't open. After viewing, content locks again.
          </div>
        </div>
      </DialogContent>
    </Dialog>
