...
import { index, jsonb, pgTable, text, timestamp, varchar, decimal, boolean, } from "drizzle-orm/pg-core";
...
export const profiles = pgTable("profiles", {
    ...
    mediaCount: varchar("media_count").default('0').notNull(),
    viewsCount: varchar("views_count").default('0').notNull(),
    subscribersCount: varchar("subscribers_count").default('0').notNull(),
